...
<body>
	...
	<h2 class = "titulo-seccion">Modulos del Sistema</h2> <?php if(isset($mensaje_error)){ ?> <h3 class="mensaje-error"><?=$mensaje_error?></h3> <?php }if(isset($mensaje_exito)){?> <h3 class="mensaje-exito"> <?=$mensaje_exito?></h3> <?php }?>
	<hr>
	...
	<?php //************************* Contenido del modulo ..... jjy ************************* ?>
		...
		<div>
			...
			<?=html_etiqueta('Información / Instrucciones sobre el contenido del presente formulario')?>
...
<?php //********************* lista simple ....... jjy ************************** ?>
			...
			<?php
				$parametros = array(
					...
					'enlace_editar'   => 'javascript:editar({@id})',
