...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?=base_url()?>libs/font-awesome/css/font-awesome.min.css"> 
	...
	<link rel="stylesheet" type="text/css" href="<?=base_url()?><?=$config['modulo']['id']?>/css/estilos_propios.css">

  <script src="<?=base_url()?>libs/jquery/jquery.min.js"></script>
  <script src="<?=base_url()?>libs/jq-validar/jquery.validate.min.js"></script>

  <script src="<?=base_url()?>js/scripts.js"></script>
  <script src="<?=base_url()?><?=$config['modulo']['id']?>/js/scripts.js"></script>