...
<body>
	...
	<?php
		...
		$parametros = array(
						'enlace'           => site_url().'/t/mostrar_tabla_general/n',
						'icono'            => 'icon-file',
						'descripcion'      => 'Nuevo',
					);
		...
		$html_salida .= html_enlace_boton('Exportar', $parametros );
...
<?php //********************* lista simple ....... jjy ************************** ?>
			...
			<?php
				$parametros = array(
					...
					'enlace_mostrar'  => site_url() 	. '/t/listar/e/{@codigo_tabla_sistema}',
					...
					'columnas' => array( // se definen los títulos de la lista en base a los campos ... jjy
						...
						'codigo_tabla_sistema'     => 'Codigo Tabla', // para ordenar ---- &nbsp;&nbsp;<i class="icon-caret-down"></i>',
						'id_tabla'     			   => 'Nombre Tabla',
			...
			?>
			<div>
			<?=html_lista_datos( 'lista_datos', $tablas, $parametros ) ?>
			</div>
